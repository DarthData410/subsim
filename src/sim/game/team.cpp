...
Team::Team(uint8_t id) : id(id), punkte(0) {
    ...
    const Sonar_Aktiv  sonar_aktiv_t("TAS-1", Sonar::Groesse::KLEIN, 15.f, 10'000, 10.f, blindspots1); // für Torpedos
    const Sonar_Aktiv  sonar_aktiv_s("SAS-1", Sonar::Groesse::GROSS, 15.f, 10'000, 10.f, blindspots2); // für Subs
    const Sonar_Passiv sonar_passiv_t("TPS-1", Sonar::Groesse::KLEIN, 0.4f, 15.f, blindspots1); // für Torpedos
    const Sonar_Passiv sonar_passiv_s("SPS-1", Sonar::Groesse::GROSS, 0.4f, 15.f, blindspots2); // für Subs
