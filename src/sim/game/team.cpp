...
Team::Team(uint8_t id) : id(id), punkte(0) {
    ...
    const Sonar_Aktiv  sonar_aktiv_t(Sonar::Groesse::KLEIN, 15.f, 10'000, 10.f, blindspots1); // für Torpedos
    const Sonar_Aktiv  sonar_aktiv_s(Sonar::Groesse::GROSS, 15.f, 10'000, 10.f, blindspots2); // für Subs
    const Sonar_Passiv sonar_passiv_t(Sonar::Groesse::KLEIN, 0.4f, 15.f, blindspots1); // für Torpedos
    const Sonar_Passiv sonar_passiv_s(Sonar::Groesse::GROSS, 0.4f, 15.f, blindspots2); // für Subs
